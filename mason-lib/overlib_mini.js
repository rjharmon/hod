...
if(ocss==CSSSTYLE)txt="<TABLE WIDTH="+owidth+" BORDER=0 style=\"border:"+oborder+"px solid "+obgcolor+"\" CELLSPACING=0><TR><TD BGCOLOR=\""+obgcolor+"\" style=\"background-color: "+obgcolor+"\"><FONT style=\"font-family: "+ocaptionfont+";color: "+ocapcolor+";font-size: "+ocaptionsize+ocaptionsizeunit+";font-weight: "+ocaptionweight+";font-style: "+ocaptionstyle+";\">"+ocapicon+title+"</FONT></TD>"+closing+"<TR><TD VALIGN=TOP style=\"color:"+ofgcolor+";background-color: "+ofgcolor+";height: "+oheight+oheightunit+";padding:2px\"><FONT style=\"font-family: "+otextfont+";color: "+otextcolor+";font-size: "+otextsize+otextsizeunit+";text-decoration: "+otextdecoration+";font-weight: "+otextweight+";font-style:"+otextstyle+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
